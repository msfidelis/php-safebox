        ...
        <div class="modal-content">
            ...
            <div>
                <div class="alert alert-danger alert-dismissible fade in" role="alert">
                    ...
                    <p>Essa ação poderá inutilizar a transação até o presente momento. Ao continuar uma nova chave de transação será enviada para o cliente. Deseja continuar?</p>
                    <p>
