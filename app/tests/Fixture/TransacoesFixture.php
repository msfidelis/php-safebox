...
class TransacoesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'id_mediador' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'path' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'dt_inicio' => '2016-09-14 02:21:56',
            'dt_fim' => '2016-09-14 02:21:56',
            'created' => '2016-09-14 02:21:56',
            'modified' => '2016-09-14 02:21:56'
        ],
    ];
}
